...
static NSString * const kFlynaxAPIUserAgent  = @"Flynax iOS App v3";
static NSString * const kFirstReleaseAppDate = @"Jun 29, 2011";
...
static BOOL const kLabeledSolution = YES;
...
static NSString * const kColorThemeGlobal          = @"ffa100";
static NSString * const kColorThemePrice           = @"b66b00";
static NSString * const kColorThemeHomePrice       = @"eb8326";
...
// menu
static NSString * const kColorMenuBadgeFill        = @"ffa100";
...
static NSString * const kColorTabsSelectionIndicator = @"ff961d";
...
static NSString * const kColorIndexBarSelectedBackground = @"ff961d";
// FLView
static NSString * const kColorFLViewBackground = @"e5e5e5";
static NSString * const kColorFLViewDefaultCenterLine = @"ff961d";
...
static NSString * const kColorRadioButtonIndicatorColor = @"ff961d";
...
static NSString * const kNotificationFavoriteBtnDidTap = @"com.flynax.subicicleta.favoriteBtnDidTap";
static NSString * const kNotificationDebugErrors       = @"com.flynax.subicicleta.debugErrors";
static NSString * const kNotificationNewCommentAdded   = @"com.flynax.subicicleta.newCommentAdded";
static NSString * const kNotificationSimulateLogin     = @"com.flynax.subicicleta.SimulateLogin";
static NSString * const kNotificationMakePayment       = @"com.flynax.subicicleta.makePaymentAfterCreateListing";
